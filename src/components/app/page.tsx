// FILE: C:\Users\redfi\eu-cbam-reporter\frontend\src\pages\public\en\index.tsx
import Link from "next/link";
import { PenaltyCalculator } from "../components/PenaltyCalculator";

export const metadata = {
  title: "GrandScope | EU CBAM Reporting Software",
  description: "Automated EU CBAM reporting & Annex 5.1 XML Generator...",
};

/**
 * Homepage using the approved palette:
 * Primary: #306263
 * Secondary: #4073AF, #FFD617
 * Backgrounds: #F5F5F5, #EBEBEB
 * Surfaces: #FFFFFF, #E3E3E3
 * Text: #404040, #707070
 * Status: #2E7D32, #F29527, #DA2131
 * Border tones: #CFCFCF, #9F9F9F
 *
 * Notes:
 * - Brand teal drives primary actions and key accents.
 * - Blue supports links and secondary emphasis.
 * - Gold is used for premium highlights and rails, kept controlled.
 */
          ...
          <div className="gsx-sectionInner">
            ...
            <div className="gsx-faq">
              ...
              <details className="gsx-faqItem">
                ...
                <div className="gsx-faqBody">
                  Penalties can be between €10 and €50 per tonne of unreported embedded emissions, depending on the competent authority assessment and the case.
                </div>
              </details>
