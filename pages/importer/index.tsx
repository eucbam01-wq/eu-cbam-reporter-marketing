    ...
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <ActionButton label="Reporting review" href="/importer/emissions-review" entitlementKey="reporting" />
          ...
          <ActionButton label="Manage suppliers" href="/importer/supplier-links" entitlementKey="action.manage_suppliers" />
        </div>
